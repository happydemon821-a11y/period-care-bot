# 🌸 Period Care AI Chatbot

A simple AI chatbot built using Python and Tkinter to help with:
- Period tracking 📅
- Pain relief tips 💢
- Food suggestions 🍎
- Exercises 🧘‍♀️
...
```bash
pip install pillow speechrecognition pyttsx3 pyaudio
```
...
## 💜 Made with care for health & comfort
